        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-charcoal/80 mb-4">
                So I did what any determined parent would do - I reached out to experienced parents, spoke with nurses, and compiled the real advice that actually works. This pack is everything I wish had existed when I was searching.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="bg-mint/10 rounded-lg p-3">
                  <div className="font-medium text-deep-green">✓ Spoke with nurses</div>
